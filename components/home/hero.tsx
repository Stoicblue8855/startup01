    ...
    <section ref={ref} className="relative h-dvh w-full overflow-hidden">
      ...
      >
        <motion.span
          ...
          className="mb-2 inline-flex w-fit items-center gap-3 text-xs uppercase tracking-luxe text-gold"
          style={{
            filter: 'drop-shadow(0 0 10px var(--background)) drop-shadow(0 0 10px var(--background))',
          }}
        >
        ...
        <h1
          className="mt-4 max-w-4xl font-serif text-5xl leading-[1.15] text-balance md:text-7xl lg:text-7xl"
          style={{
            filter:
              'drop-shadow(0 0 14px var(--background)) drop-shadow(0 0 14px var(--background)) drop-shadow(0 0 6px var(--background))',
          }}
        >
          {words.map((word, i) => (
