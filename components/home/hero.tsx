    ...
    <section ref={ref} className="relative h-dvh w-full overflow-hidden">
      ...
      >
        <motion.span
          ...
          className="mb-2 inline-flex w-fit items-center gap-3 rounded-full bg-background/30 px-4 py-2 text-xs uppercase tracking-luxe text-gold"
        >
          ...
          {words.map((word, i) => (
            <span key={i} className="mr-[0.3em] inline-block overflow-hidden align-bottom">
              <motion.span
                ...
                className="inline-block rounded-full bg-background/30 px-2.5 py-0.5 [box-decoration-break:clone] [-webkit-box-decoration-break:clone]"
              >
                {word}
              </motion.span>
            </span>
        ...
        >
          <span className="rounded-full bg-background/25 px-2 py-0.5 [box-decoration-break:clone] [-webkit-box-decoration-break:clone]">
            {hero.subheadline}
          </span>
        </motion.p>
