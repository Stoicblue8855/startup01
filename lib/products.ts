...
export const products: Product[] = [
  ...
  {
    id: 'prd-titan-skeleton',
    slug: 'titan-skeleton-automatic',
    name: 'Titan Skeleton Automatic',
    collectionSlug: null,
    reference: 'TTN-SK01',
    price: 18995,
    currency: 'INR',
    gender: 'men',
    material: 'Black PVD Steel',
    shortDescription: 'An open-dial automatic with a bold, modern silhouette.',
    description:
      'A skeletonised dial reveals the balance wheel in motion beneath a sunburst black finish, cased in scratch-resistant black PVD steel on a matching bracelet.',
    image: '/images/watch-titan-skeleton.png',
    imageAlt: 'Titan black skeleton automatic watch with exposed balance wheel on a black steel bracelet',
    hoverImage: '/images/watch-titan-skeleton.png',
    gallery: [
      { src: '/images/watch-titan-skeleton.png', alt: 'Titan Skeleton Automatic front view' },
    ],
    straps: [{ id: 'steel-bracelet-black', name: 'Black steel bracelet' }],
    sizes: ['40mm'],
    specs: [
      { label: 'Movement', value: 'Automatic, skeleton' },
      { label: 'Case material', value: 'Black PVD-coated steel' },
      { label: 'Water resistance', value: '50m' },
